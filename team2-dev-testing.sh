...
vault token create -policy=team2-dev-approle-secretid -renewable -orphan -ttl=24h
...
export SECRET_ID_VAULT_TOKEN="TEAM2_DEV_SECRET_ID_VAULT_TOKEN_PLACEHOLDER"
export ROLE_ID="TEAM2_DEV_ROLE_ID_PLACEHOLDER"
export APPROLE_NAME="team2-dev"
export PKI_ROLE_NAME="team2-dev"
export CERT_PREFIX="team2-dev"
export TRUST_ANCHOR_ARN="arn:aws:rolesanywhere:us-east-1:1234567890:trust-anchor/5b41b87c-a9b7-4816-ae05-3b2dc27a7fb3"
export PROFILE_ARN="arn:aws:rolesanywhere:us-east-1:1234567890:profile/04319b55-cfff-42e8-b0f4-0d322c558734"
export ROLE_ARN="arn:aws:iam::1234567890:role/ra-hub-team2-dev"
export SPOKE_ROLE_ARN="arn:aws:iam::0987654321:role/ra-spoke-team2-dev"
export SPIFFE_URI="spiffe://example/team2/dev/app"
