...
export SECRET_ID_VAULT_TOKEN="TEAM1_DEV_SECRET_ID_VAULT_TOKEN_PLACEHOLDER"
export ROLE_ID="TEAM1_DEV_ROLE_ID_PLACEHOLDER"
export APPROLE_NAME="team1-dev"
export PKI_ROLE_NAME="team1-dev"
export CERT_PREFIX="team1-dev"
...
export ROLE_ARN="arn:aws:iam::1234567890:role/ra-hub-team1-dev"
export SPOKE_ROLE_ARN="arn:aws:iam::0987654321:role/ra-spoke-team1-dev"
export SPIFFE_URI="spiffe://example/team1/dev/app"
